...
$mod_strings = array (
    ...
    'LBL_MEETING_INFORMATION' => 'Vergadering Overzicht', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    ...
    'LBL_EXTNOT_HEADER' => 'Fout: niet uitgenodigd', // You are not invited to the meeting messages
  ...
  //For export labels
    ...
    'LBL_EMPTY_SEARCH_RESULT' => 'Sorry, geen resultaten gevonden. Maak hieronder een genodigde aan.',  // create invitee functionallity
