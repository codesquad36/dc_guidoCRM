...
$mod_strings = array (
    ...
    'LBL_DOCUMENT_INFORMATION' => 'Document Overzicht', //Can be translated in all caps. This string will be used by SuiteP template menu actions
